...
const accountPlans = [
  {
    ...
    displayName: "Darwinex Zero 100K Allocation",
  ...
  },
  {
    ...
    displayName: "FTMO Challenge Fase 1 100K",
    broker: "FTMO",
    server: "FTMO-Server",
    login: "73018491",
    mode: "Fondeo",
  ...
  },
  {
    ...
    displayName: "The5ers High Stakes Fase 2 100K",
    broker: "The5ers",
  ...
  {
    id: "marketing-wsf-evaluation-50k",
    displayName: "WSF Evaluation 50K",
    broker: "Wall Street Funded",
    server: "WSFMarkets-Demo",
    login: "98047125",
    mode: "Fondeo",
    balance: 51260,
    start: 50000,
    ...
    fundingProfile: {
      firm: "WSF",
      account_type: "evaluation",
      phase_label: "Evaluacion",
      objective_pct: 8,
      current_progress_pct: 15.8,
      consistency_pct: 14,
      payout_cadence_label: "Tras evaluacion",
      next_payout_label: "Pendiente",
      playbook_label: "Wall Street Funded",
      recommended_risk_pct: 0.3,
    },
  },
  {
    id: "marketing-funding-pips-2step-100k",
    displayName: "Funding Pips 2-Step 100K",
