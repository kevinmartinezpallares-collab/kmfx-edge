    ...
    <div className="flex w-full min-w-0 flex-col gap-2 rounded-lg border border-border/70 bg-background/35 p-1.5 lg:w-auto lg:flex-row lg:items-center">
      <div className="flex min-w-0 items-center gap-2">
        <Button
          ...
          size="icon-sm"
          className="shrink-0"
          onClick={() => handleMonthSelect(shiftMonthKey(selectedMonthKey, viewMode === "year" ? -12 : -1))}
                          ...
                          cell.inMonth ? (
                            ...
                            >
                              ...
                              <div className="mt-2 xl:mt-5">
                                <p
                                  className="max-w-full break-words font-mono text-[11px] font-medium leading-tight text-foreground md:text-xs"
                                >
