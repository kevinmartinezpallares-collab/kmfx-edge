        ...
        <div className="flex min-w-0 items-center gap-4">
          <div className="group relative shrink-0">
            ...
            <button
              ...
              className="absolute -bottom-3 -right-3 flex size-11 items-center justify-center rounded-full border border-border/70 bg-background text-foreground shadow-sm transition-colors hover:bg-muted"
...
> = {
  ...
  plan_required: {
    ...
    steps: [
      ...
      ["2", "Launcher y EA", "Instala la versión preparada para producción."],
