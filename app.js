import { createStore } from "./js/modules/store.js?v=build-20260505-004000";
import { initNavigation } from "./js/modules/navigation.js?v=build-20260505-004000";
import { renderDashboard } from "./js/modules/dashboard.js?v=build-20260505-004000";
import { renderAnalytics } from "./js/modules/analytics.js?v=build-20260505-004000";
import { openPostTradeModal, renderDiscipline } from "./js/modules/discipline.js?v=build-20260505-004000";
import { renderRisk } from "./js/modules/risk.js?v=build-20260505-004000";
import { renderTrades } from "./js/modules/trades.js?v=build-20260505-004000";
import { renderCalendar } from "./js/modules/calendar.js?v=build-20260505-004000";
import { initAccountsUI } from "./js/modules/accounts-ui.js?v=build-20260505-004000";
import { initAccountsLiveSnapshot } from "./js/modules/accounts-live-snapshot.js?v=build-20260505-004000";
import { initConnections, renderConnections } from "./js/modules/connections.js?v=build-20260505-004000";
import { initCalculator, renderCalculator } from "./js/modules/calculator.js?v=build-20260505-004000";
import { initJournal, renderJournal } from "./js/modules/journal.js?v=build-20260505-004000";
import { initStrategies, renderStrategies } from "./js/modules/strategies.js?v=build-20260505-004000";
import { initFunded, renderFunded } from "./js/modules/funded.js?v=build-20260505-004000";
import { renderMarket } from "./js/modules/market.js?v=build-20260505-004000";
import { renderPortfolio } from "./js/modules/portfolio.js?v=build-20260505-004000";
import { renderGlossary } from "./js/modules/glossary.js?v=build-20260505-004000";
import { renderDebug } from "./js/modules/debug.js?v=build-20260505-004000";
import { initPullToRefresh } from "./js/modules/pull-to-refresh.js?v=build-20260505-004000";
import "./js/modules/modal-system.js?v=build-20260505-004000";
import { initAccountRuntime } from "./js/modules/account-runtime.js?v=build-20260505-004000";
import { initTopbarStatus } from "./js/modules/topbar-status.js?v=build-20260505-004000";
import { initSidebarUI } from "./js/modules/sidebar-ui.js?v=build-20260505-004000";
import { initSidebarVNext } from "./js/modules/sidebar-vnext.js?v=build-20260505-004000";
import { initConnectionWizard } from "./js/modules/connection-wizard.js?v=build-20260505-004000";
import { initAuthUI } from "./js/modules/auth-ui.js?v=build-20260505-004000";
import { analyticsTabForPage, pageFromLocation, parentPageForPage } from "./js/modules/route-map.js?v=build-20260505-004000";
import {
...
} from "./js/modules/auth-session.js?v=build-20260505-004000";
import { applyAvatarContent } from "./js/modules/avatar-utils.js?v=build-20260505-004000";
import {
...
} from "./js/modules/supabase-user-config.js?v=build-20260505-004000";
import { resolveActiveAccountId, selectCurrentAccount, selectCurrentModel } from "./js/modules/utils.js?v=build-20260505-004000";
import { resolveAccountsRegistryUrl, resolveAccountsSnapshotUrl, resolveApiBaseUrl } from "./js/modules/api-config.js?v=build-20260505-004000";

const BUILD_TAG = "build-20260505-004000";
