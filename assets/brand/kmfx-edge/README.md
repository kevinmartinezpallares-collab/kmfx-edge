...
| `web` | Snippets para aplicar favicon, manifest y metadata en la app. |
| `docs` | Guia de identidad y narrativa del logo. |
...
| Instagram/LinkedIn square | `social/social-square-1080.png` |
| Web Open Graph | `social/og-image-1200x630.png` |
| X/Twitter header | `social/x-header-1500x500.png` |
| LinkedIn cover | `social/linkedin-cover-1584x396.png` |
| YouTube channel art | `social/youtube-channel-art-2560x1440.png` |

## Significado base

KMFX Edge no representa solo un porcentaje. Representa una mentalidad:

- El circulo: capital, punto de partida y decision inicial.
- La linea: equity, direccion, disciplina y construccion ascendente.
- El arco: score, evaluacion, gestion del riesgo y mejora continua.

La lectura completa es: disciplina, estrategia y resultados.
