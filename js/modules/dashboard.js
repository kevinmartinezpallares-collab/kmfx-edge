...
export function renderDashboard(root, state) {
  ...
  chartSpecs.push(
    lineAreaSpec("dashboard-hero-equity-chart", heroCurve, {
      ...
      borderWidth: 3,
      pointRadius: (context) => (context.dataIndex === heroCurve.length - 1 ? 4.6 : 0),
      pointHoverRadius: (context) => (context.dataIndex === heroCurve.length - 1 ? 5.2 : 3.4),
      pointHitRadius: 20,
      fill: isDarkTheme,
      fillAlphaStart: isDarkTheme ? 0.22 : 0.09,
      fillAlphaEnd: isDarkTheme ? 0.045 : 0.016,
      glowAlpha: 0,
      tension: 0.96,
      animationDuration: 0,
