...
import { buildApiUrl } from "./api-config.js?v=build-20260514-230900";
import { showToast } from "./toast.js?v=build-20260514-230900";
import { formatCurrency, selectActiveDashboardPayload } from "./utils.js?v=build-20260514-230900";
import { emptyStateMarkup, pageHeaderMarkup, pnlTextMarkup } from "./ui-primitives.js?v=build-20260514-230900";
import { buildBacktestVsRealReport, renderBacktestVsRealSection } from "./backtest-real.js?v=build-20260514-230900";
