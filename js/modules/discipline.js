import { formatCurrency, formatPercent, selectCurrentModel } from "./utils.js?v=build-20260406-191800";
import { barChartSpec, chartCanvas, mountCharts } from "./chart-system.js?v=build-20260406-191800";
...
export function renderDiscipline(root, state) {
  ...
  mountCharts(root, [
    barChartSpec("discipline-hourly-behavior", disciplineChartRows.map((hour) => ({
      ...
      barPercentage: 0.95,
      barThickness: isMobileViewport ? 26 : 38,
      maxBarThickness: isMobileViewport ? 30 : 44,
      trackMinWidth: isMobileViewport ? 22 : 32,
      trackMaxWidth: isMobileViewport ? 28 : 38,
      trackWidthRatio: 0.98,
      fillInset: isMobileViewport ? 0.35 : 0.5,
      trackTopInset: 8,
      trackBottomInset: 4,
      xOffset: true,
      xTickPadding: isMobileViewport ? 10 : 6,
      autoSkipXTicks: false,
      yTickPadding: 8,
      layoutPaddingLeft: isMobileViewport ? 8 : 16,
      layoutPaddingRight: isMobileViewport ? 8 : 16,
      showYGrid: false,
      showXGrid: false,
      showYAxis: false,
      xAxisFormatter: (label, index, point) => (point?.value ? label : ""),
      maxXTicks: isMobileViewport ? 7 : 6,
      maxYTicks: 4,
