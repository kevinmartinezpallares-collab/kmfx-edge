import { analyticsTabForPage, navigationParentForPage } from "./route-map.js?v=build-20260504-080918";
...
const moreListSections = [
  ...
  },
  {
    label: "Soporte / Admin",
    items: [
      { page: "debug", label: "Soporte técnico", adminOnly: true, icon: '<path d="M9 3h6"></path><path d="M10 6h4"></path><rect x="7" y="8" width="10" height="10" rx="2"></rect><path d="M4 11h3"></path><path d="M17 11h3"></path><path d="M10 12h4"></path><path d="M10 15h4"></path>' },
