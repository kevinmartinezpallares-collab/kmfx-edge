...
const KPI_DEFINITIONS = Object.freeze({
  net_return: {
    ...
    traderUse: "Te dice si tu edge está creciendo después de costes. Sirve para decidir si mantener el ritmo, reducir riesgo o revisar el sistema.",
    formula: "P&L neto acumulado / capital de referencia.",
    sourceLabel: "Datos MT5 normalizados: balance, equity, P&L y operaciones cerradas.",
  ...
  max_drawdown: {
    ...
    refresh: "intraday",
    category: "Riesgo",
    tooltip: "Mayor caída pico-a-valle del periodo.",
    traderUse: "Mide el dolor máximo de la curva. Sirve para ajustar tamaño y saber si la cuenta soporta tu método.",
    formula: "max((pico de equity - valle posterior) / pico de equity).",
    sourceLabel: "Curva de equity y drawdown normalizada desde MT5.",
    confidence: "Mejora con historial continuo; las cuentas recién conectadas pueden infravalorarlo.",
  },
  var_95: {
    label: "VaR 95",
    unit: "currency",
  ...
  var_99: {
    ...
    refresh: "hourly",
    category: "Riesgo",
    tooltip: "Pérdida máxima esperada al 99% de confianza.",
    traderUse: "Mira el escenario de cola más duro. Sirve para calibrar límites antes de aumentar lotaje o entrar en fondeo.",
    formula: "Percentil 99 de pérdidas cerradas normalizadas; CVaR = media de la cola extrema.",
  ...
  exposure: {
    ...
    tooltip: "Exposición neta y bruta sobre capital.",
    traderUse: "Muestra cuánto capital está comprometido ahora. Sirve para evitar concentración, correlación excesiva y sobreoperar.",
    formula: "Riesgo abierto bruto y neto / capital; el neto respeta dirección long/short.",
    sourceLabel: "Posiciones abiertas y resumen de riesgo de KMFX.",
  ...
  vol_ann: {
    ...
    refresh: "eod",
    category: "Riesgo",
    tooltip: "Desviación estándar anualizada de retornos diarios.",
    traderUse: "Mide lo nerviosa que está la cuenta. Sirve para bajar agresividad cuando la curva se vuelve inestable.",
    formula: "Desviación estándar de retornos diarios x raíz(252).",
    sourceLabel: "Retornos diarios normalizados por día contable.",
    confidence: "Necesita suficientes días con actividad; con poca muestra es orientativa.",
  },
  sortino: {
    label: "Sortino",
    unit: "ratio",
  ...
  dscore: {
    ...
    traderUse: "Resume calidad operativa. Sirve para detectar cuando bajar al detalle de disciplina, riesgo o ejecución.",
    formula: "Score compuesto KMFX de consistencia, riesgo, ejecución y calidad de muestra.",
    sourceLabel: "Modelo de calidad KMFX calculado con rendimiento, riesgo y ejecución.",
    confidence: "Complementa la revisión manual; no sustituye el criterio del trader.",
  },
});
...
function kpiExplainTooltip(explain) {
  return [
    explain.summary,
    explain.formula ? `Fórmula: ${explain.formula}` : "",
