import { formatCompact, formatCurrency, formatPercent, getAccountingDayKey, getAccountingHour, getAccountingMonthKey, getAccountingWeekdayIndex, resolveAccountDataAuthority, resolveActiveAccountId, selectCurrentAccount, selectCurrentModel } from "./utils.js?v=build-20260514-091500";
import { barChartSpec, chartCanvas, lineAreaSpec, mountCharts } from "./chart-system.js?v=build-20260514-091500";
import { computeRiskAlerts } from "./risk-alerts.js?v=build-20260514-091500";
import { badgeMarkup } from "./status-badges.js?v=build-20260514-091500";
import { renderAdminTracePanel } from "./admin-mode.js?v=build-20260514-091500";
...
function resolveRiskProtectionMeta({
  ...
  if (hasLocalSnapshot && !connectionConnected) {
    return {
      ...
      note: "Hay una política conocida, pero falta confirmación reciente de aplicación."
    };
  }
  ...
  if (!connectionConnected && !hasLocalSnapshot) {
    return {
      ...
      note: "Primero hay que enlazar la protección de KMFX para enviar y aplicar reglas."
    };
  }
  ...
  if (isConfigured) {
    return {
      ...
      note: "La política ya existe, pero falta confirmación de aplicación reciente."
    };
  }
