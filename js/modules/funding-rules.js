...
function createPhaseRule(firm, program, phaseId, values = {}) {
  ...
  return Object.freeze({
    ...
    rewardPct: values.rewardPct ?? values.payoutSplitPct ?? program.rewardPct ?? program.payoutSplitPct ?? null,
    payoutSplitPct: values.payoutSplitPct ?? values.rewardPct ?? program.payoutSplitPct ?? program.rewardPct ?? null,
    sourceNote,
...
export const FUNDING_RULE_PRESETS = Object.freeze({
  "Orion Funded": firmPreset(orion, {
    ...
    "Orion Standard/Swing": createProgram(
      orion,
      {
        programId: "orion-standard-swing",
        programName: "Orion Standard/Swing",
        aliases: ["Standard", "Swing", "Orion Standard", "Orion Swing"],
        sourceType: "user_manual",
        sourceUrl: "",
        versionLabel: "Standard / Swing",
        appliesToPurchasesFrom: null,
        verified: false,
        requiresReview: true,
        sourceNote: "Reglas introducidas desde captura del dashboard Orion Standard; confirmar en documentación oficial.",
        notes: "Captura de Orion Standard: objetivo 8% / 5%, DD diario 5%, pérdida máxima 10%, drawdown estático, 4 días mínimos y recompensa 80%.",
      },
      {
        dailyLossLimitPct: 5,
        maxLossLimitPct: 10,
      ...
      },
      {
        ...
        Verification: {
          phaseName: "Phase 2 / Verification",
          profitTargetPct: 5,
        },
        Funded: {
          phaseName: "Funded",
