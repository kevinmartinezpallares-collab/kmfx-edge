...
function normalizeReportMetrics(rawMetrics = {}, context = {}) {
  ...
  const normalized = {
    ...
    netGrossProfit: toFiniteNumber(rawMetrics.netGrossProfit),
    netGrossLoss: toFiniteNumber(rawMetrics.netGrossLoss),
    winRate: toFiniteNumber(rawMetrics.winRate),
    totalTrades: toFiniteNumber(rawMetrics.totalTrades, context.totalTrades ?? 0),
    profitFactor: toFiniteNumber(rawMetrics.netProfitFactor ?? rawMetrics.profitFactor),
    grossProfitFactor: toFiniteNumber(rawMetrics.grossProfitFactor),
    netProfitFactor: toFiniteNumber(rawMetrics.netProfitFactor ?? rawMetrics.profitFactor),
    profitFactorBasis: rawMetrics.profitFactorBasis || (rawMetrics.netProfitFactor != null ? "net" : "legacy"),
